...
namespace MiProyecto.scripts
{
    ...
    {
        public void ejercicios(int ejercicio) {

        // ejercicio 1

        if (ejercicio == 1) {
            Console.Write("Ejercicio 1: Ingrese un número entero de dos dígitos: ");
            bool result = int.TryParse(Console.ReadLine(), out int num1);
        ...
        if (ejercicio == 2){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num2);
        ...
        if (ejercicio == 3){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num3);
        ...
        if (ejercicio == 4){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num4a);
            bool result2 = int.TryParse(Console.ReadLine(), out int num4b);
        ...
        if (ejercicio == 5){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num5);
        ...
        if (ejercicio == 6) {
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num6);
        ...
        if (ejercicio == 7) {
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num7a);
            bool result2 = int.TryParse(Console.ReadLine(), out int num7b);
            bool result3 = int.TryParse(Console.ReadLine(), out int num7c);
        ...
        if (ejercicio == 8) {
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num8);
        ...
        if (ejercicio == 9){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num9);
        ...
        if (ejercicio == 10){
            ...
            bool result = int.TryParse(Console.ReadLine(), out int num10a);
            bool result2 = int.TryParse(Console.ReadLine(), out int num10b);
